...
module.exports = {
	...
	postEvent: async (req, res, next) => {
		try {
			...
			// req.body.currentTrack = req.body.playlist.tracks.data[0]._id.toString()
			...
			// event = await modelEvent.findOneAndUpdate({_id : event._id}, {isPlaying: event.playlist.tracks.data[0]._id}, {new: true})
