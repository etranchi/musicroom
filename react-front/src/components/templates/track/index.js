...
export default  class liveEvent extends Component {
	render() {
        ...
        if (this.props.track.userLike && this.props.track.userLike.length > 0)
        {
            if (this.props.track.userLike.indexOf(this.props.userID) != -1)
                isLike = true
        }
        if (this.props.track.userUnLike && this.props.track.userUnLike.length > 0)
        {
                    ...
                    <Row>
                        ...
                        <Col span={20}>
                            ...
                            [
                                ...
                                <i onClick={this.props.callSocket.bind(this,"updateScore", this.props.track, -1)} style={isUnLike ? {display:'none'}  : {display:'block', margin:'0 1% 0 0'} } className="far fa-thumbs-down HoverUnlike"></i>
                            ]}>
